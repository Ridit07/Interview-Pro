...
# Enhanced similarity calculation with Levenshtein distance and sequence matching
def calculate_similarity(predicted_text, transcribed_text):
    # Use Levenshtein ratio for direct character-level similarity
    levenshtein_similarity = levenshtein_ratio(predicted_text, transcribed_text) * 100
    
    # Use SequenceMatcher for a secondary similarity measure based on sequence matching
    ...
    # Combine both similarity measures (averaging them)
    combined_similarity = (levenshtein_similarity + sequence_matcher_similarity) / 2
...
# /Users/riditjain/Downloads/bbaf5a.mp4
# /Users/riditjain/Downloads/LipNet-main/models/checkpoint