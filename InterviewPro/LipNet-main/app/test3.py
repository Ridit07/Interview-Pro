...
def calculate_semantic_similarity(predicted_text, transcribed_text):
    # Load a pre-trained sentence transformer model
    model = SentenceTransformer('all-MiniLM-L6-v2')
    
    # Compute embeddings
    embedding1 = model.encode(predicted_text, convert_to_tensor=True)
    embedding2 = model.encode(transcribed_text, convert_to_tensor=True)
...
def calculate_similarity(predicted_text, transcribed_text):
    ...
    semantic_similarity = calculate_semantic_similarity(predicted_text, transcribed_text)

    # Weighted combination of all scores
    combined_similarity = (levenshtein_similarity * 0.2 +
                           sequence_matcher_similarity * 0.2 +
...
if __name__ == "__main__":
    video_path = '/Users/riditjain/Downloads/bbaf5a.mp4'  
